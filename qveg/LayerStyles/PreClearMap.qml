...
<qgis styleCategories="AllStyleCategories" simplifyMaxScale="1" minScale="100000000" simplifyDrawingTol="1" readOnly="0" simplifyDrawingHints="1" maxScale="0" labelsEnabled="0" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" version="3.22.4-Białowieża" symbologyReferenceScale="-1">
  <flags>
  ...
  <renderer-v2 enableorderby="0" type="categorizedSymbol" attr="VM_POLY" referencescale="-1" forceraster="0" symbollevels="0">
    <categories>
      <category value="E-dom" label="Pre-clear area containing endangered RE" symbol="0" render="true"/>
      <category value="E-subdom" label="Pre-clear area containing endangered RE" symbol="1" render="true"/>
      <category value="O-dom" label="Pre-clear area containing of-concern RE" symbol="2" render="true"/>
      <category value="O-subdom" label="Pre-clear area containing of-concern RE" symbol="3" render="true"/>
      <category value="LeastC" label="Pre-clear area containing least-concern RE" symbol="4" render="true"/>
      <category value="estuary" label="Water" symbol="5" render="true"/>
      <category value="island" label="Water" symbol="6" render="true"/>
      <category value="ocean" label="Water" symbol="7" render="true"/>
      <category value="png" label="Water" symbol="8" render="true"/>
      <category value="sand" label="Water" symbol="9" render="true"/>
      <category value="shallow" label="Water" symbol="10" render="true"/>
      <category value="aust" label="Other" symbol="11" render="true"/>
    </categories>
    <symbols>
      ...
      <symbol type="fill" alpha="1" name="2" clip_to_extent="1" force_rhr="0">
        ...
        <layer locked="0" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
            <Option type="QString" value="3x:0,0,0,0,0,0" name="border_width_map_unit_scale"/>
            <Option type="QString" value="255,102,15,255" name="color"/>
            <Option type="QString" value="bevel" name="joinstyle"/>
            <Option type="QString" value="0,0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
  ...
  <customproperties>
    <Option type="Map">
      <Option type="List" name="dualview/previewExpressions">
        <Option type="QString" value="&quot;RE_LABEL&quot;"/>
      </Option>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory penColor="#000000" backgroundAlpha="255" minimumSize="0" lineSizeScale="3x:0,0,0,0,0,0" width="15" sizeScale="3x:0,0,0,0,0,0" barWidth="5" penWidth="0" direction="0" spacing="5" opacity="1" rotationOffset="270" maxScaleDenominator="1e+08" backgroundColor="#ffffff" penAlpha="255" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" showAxis="1" enabled="0" lineSizeType="MM" scaleDependency="Area" spacingUnit="MM" diagramOrientation="Up" scaleBasedVisibility="0" sizeType="MM" height="15" minScaleDenominator="0">
  ...
  <aliases>
    ...
    <alias name="" field="ruleid" index="30"/>
    <alias name="" field="layer" index="31"/>
    <alias name="" field="path" index="32"/>
  </aliases>
  <defaults>
    ...
    <default applyOnUpdate="0" expression="" field="ruleid"/>
  ...
  <constraints>
    ...
    <constraint exp_strength="0" notnull_strength="0" unique_strength="0" field="ruleid" constraints="0"/>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column hidden="0" width="-1" type="field" name="ruleid"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <reuseLastValue>
    ...
    <field name="ruleid" reuseLastValue="0"/>
  ...
  <widgets/>
  <previewExpression>"re_label"</previewExpression>
