...
<qgis version="3.10.5-A Coruña" styleCategories="AllStyleCategories" readOnly="0" simplifyMaxScale="1" maxScale="0" simplifyLocal="1" simplifyDrawingHints="1" labelsEnabled="0" simplifyAlgorithm="0" simplifyDrawingTol="1" hasScaleBasedVisibilityFlag="0" minScale="1e+08">
    ...
    <symbols>
      <symbol name="0" alpha="1" type="fill" force_rhr="0" clip_to_extent="1">
        <layer pass="0" enabled="1" class="SimpleFill" locked="0">
          ...
          <prop k="outline_color" v="0,112,255,255"/>
  ...
  <aliases>
    ...
    <alias field="KPA" index="1" name=""/>
  </aliases>
  <excludeAttributesWMS/>
  <excludeAttributesWFS/>
  <defaults>
    <default field="OBJECTID" expression="" applyOnUpdate="0"/>
    <default field="KPA" expression="" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint field="OBJECTID" notnull_strength="1" unique_strength="1" exp_strength="0" constraints="3"/>
    <constraint field="KPA" notnull_strength="0" unique_strength="0" exp_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="OBJECTID" exp="" desc=""/>
    <constraint field="KPA" exp="" desc=""/>
  </constraintExpressions>
  <expressionfields/>
  <attributeactions>
  ...
  <attributetableconfig sortOrder="0" actionWidgetStyle="dropDown" sortExpression="">
    <columns>
      ...
      <column name="KPA" hidden="0" width="-1" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field name="KPA" editable="1"/>
    <field name="OBJECTID" editable="1"/>
  </editable>
  <labelOnTop>
    <field name="KPA" labelOnTop="0"/>
